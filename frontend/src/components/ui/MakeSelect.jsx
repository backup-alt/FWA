...
const BIKE_BRANDS = [
  ...
  'Ola Electric', 'Piaggio', 'Rajdoot', 'Singer', 'Styla', 'Techo', 'Trinity',
  'Vida', 'Woloo', 'Yulu', 'Other'
];
  ...
  return (
    <div className="w-full relative" ref={containerRef}>
      <Listbox value={value || ''} onChange={handleSelect}>
        ...
        >
          <span className="block truncate">{value || 'Select Make'}</span>
          ...
          <Listbox.Options className="absolute z-[9999] mt-1 w-full max-h-60 overflow-auto rounded-xl bg-white dark:bg-gray-800 py-1 shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 focus:outline-none border border-gray-100 dark:border-gray-700">
            <div className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 px-2 pb-1 shadow-sm">
              ...
              <button
                ...
                className="mt-1 w-full flex items-center justify-center gap-1.5 py-1.5 text-sm text-primary-600 hover:text-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-lg transition-colors border border-dashed border-primary-300 dark:border-primary-700"
              >
