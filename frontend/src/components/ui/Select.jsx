      ...
      <Listbox value={value || ''} onChange={handleChange} disabled={disabled}>
        <div className="relative">
          ...
          >
            <Listbox.Options
              static
              className="absolute z-[100] mt-1.5 max-h-60 w-full overflow-auto rounded-xl bg-white dark:bg-gray-800 py-1.5 shadow-xl ring-1 ring-gray-200 dark:ring-gray-700 focus:outline-none text-sm"
              style={{ minWidth: '100%' }}
            >
              {options.length === 0 ? (
